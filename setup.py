#modified version of setup.py for compatibility with 18.04LTSq
#scotchman0. All of the below data is forked directly from the 3.1.9 branch
#of https://github.com/cellprofiler/cellprofiler
#I have simply modified the 'requires' section more times than can be automated
#and it now requires a standalone setup.py script that is compatible with latest builds of python
#The original setup.py now resides in /tmp/cellprofilerstuff as: setup.py.original if you need it.
import codecs
import os
import re
